...
IL_0118:
	{
		...
		float L_52;
		L_52 = Vector3_Distance_m2314DB9B8BD01157E013DF87BEA557375C7F9FF9_inline(L_47, L_51, NULL);
		(&V_10)->___distance_2 = L_52;
		...
		(&V_10)->___screenPosition_11 = L_62;
		int32_t L_63 = V_2;
		(&V_10)->___displayIndex_12 = L_63;
		List_1_t8292C421BBB00D7661DC07462822936152BAB446* L_64 = ___1_resultAppendList;
		NullCheck(L_64);
		int32_t L_65;
	...
	{
		int32_t L_68;
		L_68 = SortingGroup_get_invalidSortingGroupID_mEA453186185B225FA2410988959180BAEC604310(NULL);
		G_B23_0 = L_68;
		G_B23_1 = G_B21_0;
		goto IL_01f2;
	}
...
IL_01eb:
	{
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF* L_69 = V_6;
		NullCheck(L_69);
		int32_t L_70;
		L_70 = Renderer_get_sortingGroupID_m1DEFE39027236FF31AB603993BBC13C072E52118(L_69, NULL);
		G_B23_0 = L_70;
		G_B23_1 = G_B22_0;
	}
...
IL_01f2:
	{
		...
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF* L_71 = V_6;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_72;
...
IL_0206:
	{
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF* L_73 = V_6;
		NullCheck(L_73);
		int32_t L_74;
		L_74 = Renderer_get_sortingGroupOrder_m40F058B3AFC92CCEF2475E0BD9A96464154E999E(L_73, NULL);
		G_B26_0 = L_74;
		G_B26_1 = G_B25_0;
	}
...
IL_020d:
	{
		...
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF* L_75 = V_6;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_76;
...
IL_0221:
	{
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF* L_77 = V_6;
		NullCheck(L_77);
		int32_t L_78;
		L_78 = Renderer_get_sortingLayerID_m3D7AE74F1B87099810CF969CB4520C85F9AE5F92(L_77, NULL);
		G_B29_0 = L_78;
		G_B29_1 = G_B28_0;
	}
...
IL_0228:
	{
		...
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF* L_79 = V_6;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_80;
...
IL_023c:
	{
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF* L_81 = V_6;
		NullCheck(L_81);
		int32_t L_82;
		L_82 = Renderer_get_sortingOrder_m4CE7ADEEC8E2F28CC1D10B1D4091A10F8F1583FA(L_81, NULL);
		G_B32_0 = L_82;
		G_B32_1 = G_B31_0;
	}
...
IL_0243:
	{
		...
		RaycastResult_tEC6A7B7CABA99C386F054F01E498AEC426CF8023 L_83 = V_10;
		V_8 = L_83;
		...
		RaycastResult_tEC6A7B7CABA99C386F054F01E498AEC426CF8023 L_84 = V_8;
		int32_t L_85 = L_84.___sortingGroupID_5;
		int32_t L_86;
		L_86 = SortingGroup_get_invalidSortingGroupID_mEA453186185B225FA2410988959180BAEC604310(NULL);
	...
	{
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF* L_87 = V_6;
		NullCheck(L_87);
		int32_t L_88;
		L_88 = Renderer_get_sortingGroupID_m1DEFE39027236FF31AB603993BBC13C072E52118(L_87, NULL);
		SortingGroup_tA8DA95BF22F76688DAF54122EB3EEA35C70E9759* L_89;
		L_89 = SortingGroup_GetSortingGroupByIndex_mC4CFB06D8C4B0EA27FC4BDC60AA05F4E0B28426B(L_88, NULL);
		V_9 = L_89;
		SortingGroup_tA8DA95BF22F76688DAF54122EB3EEA35C70E9759* L_90 = V_9;
		if (!L_90)
		{
			goto IL_02b3;
		}
	}
	{
		...
		L_91 = Ray_get_direction_m21C2D22D3BD4A683BD4DC191AB22DD05F5EC2086((&V_0), NULL);
		SortingGroup_tA8DA95BF22F76688DAF54122EB3EEA35C70E9759* L_92 = V_9;
		NullCheck(L_92);
		...
		L_95 = Ray_get_origin_m97604A8F180316A410DCD77B7D74D04522FA1BA6((&V_0), NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_96;
		L_96 = Vector3_op_Subtraction_mE42023FF80067CB44A1D4A27EB7CF2B24CABB828_inline(L_94, L_95, NULL);
		float L_97;
		L_97 = Vector3_Dot_mBB86BB940AA0A32FA7D3C02AC42E5BC7095A5D52_inline(L_91, L_96, NULL);
		(&V_8)->___distance_2 = L_97;
		// result.sortingLayer = sortingGroup.sortingLayerID;
		SortingGroup_tA8DA95BF22F76688DAF54122EB3EEA35C70E9759* L_98 = V_9;
		NullCheck(L_98);
		int32_t L_99;
		L_99 = SortingGroup_get_sortingLayerID_m37C70CEA78DA6E28F405C67EDE95D5C2191F0055(L_98, NULL);
		(&V_8)->___sortingLayer_7 = L_99;
		// result.sortingOrder = sortingGroup.sortingOrder;
		SortingGroup_tA8DA95BF22F76688DAF54122EB3EEA35C70E9759* L_100 = V_9;
		NullCheck(L_100);
		int32_t L_101;
		L_101 = SortingGroup_get_sortingOrder_mC80606E6BB9A6D5E3AB61A0451C48203A0C1AB6A(L_100, NULL);
		(&V_8)->___sortingOrder_8 = L_101;
	}

IL_02b3:
	{
		// resultAppendList.Add(result);
		List_1_t8292C421BBB00D7661DC07462822936152BAB446* L_102 = ___1_resultAppendList;
		RaycastResult_tEC6A7B7CABA99C386F054F01E498AEC426CF8023 L_103 = V_8;
		NullCheck(L_102);
		List_1_Add_mEB6DFEA132B5B7BF540D34177054003185D250E7_inline(L_102, L_103, List_1_Add_mEB6DFEA132B5B7BF540D34177054003185D250E7_RuntimeMethod_var);
		// for (int b = 0, bmax = hitCount; b < bmax; ++b)
		int32_t L_104 = V_4;
...
IL_0010:
	...
	}
	{
		...
		*((int32_t*)L_8) = (int32_t)il2cpp_codegen_cast_double_to_int<int32_t>(L_10);
		...
		L_13 = VirtualFuncInvoker0< Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* >::Invoke(18 /* UnityEngine.Camera UnityEngine.EventSystems.BaseRaycaster::get_eventCamera() */, __this);
		NullCheck(L_13);
		int32_t L_14;
...
IL_004f:
	{
		...
		bool L_21;
		L_21 = Rect_Contains_mB1160CD465F3E9616AA4EED72AFFD611BD8D2B6B((&V_2), L_20, NULL);
		if (L_21)
		{
			goto IL_0067;
		}
...
IL_0067:
	{
		...
		L_23 = VirtualFuncInvoker0< Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* >::Invoke(18 /* UnityEngine.Camera UnityEngine.EventSystems.BaseRaycaster::get_eventCamera() */, __this);
		...
		*(Ray_t2B1742D7958DC05BDC3EFC7461D3593E1430DC00*)L_22 = L_25;
		...
		L_27 = Ray_get_direction_m21C2D22D3BD4A683BD4DC191AB22DD05F5EC2086(L_26, NULL);
	...
	}
	{
		...
		L_32 = VirtualFuncInvoker0< Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* >::Invoke(18 /* UnityEngine.Camera UnityEngine.EventSystems.BaseRaycaster::get_eventCamera() */, __this);
		NullCheck(L_32);
		float L_33;
		...
		L_34 = VirtualFuncInvoker0< Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* >::Invoke(18 /* UnityEngine.Camera UnityEngine.EventSystems.BaseRaycaster::get_eventCamera() */, __this);
		NullCheck(L_34);
		float L_35;
...
IL_004e:
	{
		...
		float* L_14 = (float*)(&__this->___distance_2);
		String_t* L_15;
		...
		float* L_18 = (float*)(&__this->___index_3);
		String_t* L_19;
		...
		int32_t* L_22 = (int32_t*)(&__this->___depth_4);
		String_t* L_23;
		...
		int32_t* L_48 = (int32_t*)(&__this->___sortingLayer_7);
		String_t* L_49;
		...
		int32_t* L_52 = (int32_t*)(&__this->___sortingOrder_8);
		String_t* L_53;
